...
typedef enum {
    ...
    BLINKING_BUTTON_RELEASED        // Cancellation confirmed, waiting for release
} button_state_t;
        ...
        switch (current_state) {
            case IDLE:
                ...
                if (button_level == 1) {
                    ...
                    current_state = BUTTON_PRESSED;º
            ...
            case BLINKING:
                ...
                if (button_level == 1) {
                    ...
                    if (blink_elapsed >= BLINK_DURATION_MS) {
                        ...
                        // Continue blinking
                        TickType_t blink_period_elapsed = (current_time - last_blink_time) * portTICK_PERIOD_MS;
                        if (blink_period_elapsed >= BLINK_PERIOD_MS / 2) { // Toggle every 100ms
                            s_led_state = !s_led_state;
                            set_led(s_led_state);
                            last_blink_time = current_time;
                        }
            ...
            case BLINKING_BUTTON_PRESSED:
                ...
                if (button_level == 0) {
                    ...
                    if (elapsed >= LONG_PRESS_TIME_MS) {
                        ...
                        current_state = BLINKING_BUTTON_RELEASED;
